    ...
    public class DiscussionContentViewModel : ViewModelBase
    {
        ...
        private bool IsCurrentViewActivated()
        {
            var activeView =
                _regionManager.Regions["ContentRegion"].ActiveViews.FirstOrDefault(
                    av => av.GetType().Name == GlobalResources.DiscussionContentView);
        ...
        private async Task GotoMeeting(int meetingId)
        {
            ...
            await _discussionContentView.Dispatcher.BeginInvoke(new Action(() =>
            {
                ...
                DiscussionClassView discussionClassView =
                    new DiscussionClassView(MeetingService_StartMeetingCallbackEvent,
                        MeetingService_ExitMeetingCallbackEvent);

                discussionClassView.Show();

                //IMeeting meetingService = IoC.Get<IMeeting>();
